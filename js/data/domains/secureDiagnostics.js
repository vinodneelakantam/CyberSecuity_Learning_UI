...
export const profile = {
  ...
  context:
    "SecureDiagnostics follows International Organization for Standardization (ISO) 14229 Unified Diagnostic Services (UDS) Security Access service 0x27 seed/key exchange backed by the Texas Instruments Security Accelerator (SA2UL) crypto block, gated by Automotive Open System Architecture (AUTOSAR) Diagnostic Event Manager (DEM) vehicle-state and anti-brute-force delay timers.",
  participants: [
    "Diagnostic tester (Diagnostics over Internet Protocol / DoIP / Unified Diagnostic Services / UDS)",
    "Unified Diagnostic Services (UDS) session manager",
    "Security Access Handler (0x27)",
    "Texas Instruments Security Accelerator (SA2UL) crypto block",
    "Vehicle state / Diagnostic Event Manager (DEM)",
    "Diag Audit Trail"
  ],
  architecture: {
    nodes: [
      "Diagnostic tester (Diagnostics over Internet Protocol / DoIP / Unified Diagnostic Services / UDS client)",
      "Unified Diagnostic Services (UDS) session manager (0x10)",
      "Security Access Handler (0x27 seed/key)",
      "Texas Instruments Security Accelerator (SA2UL) crypto block",
      "Vehicle state engine + Automotive Open System Architecture (AUTOSAR) Diagnostic Event Manager (DEM)"
    ],
    links: [
      "Session transition governance (default to extended/programming)",
      "International Organization for Standardization (ISO) 14229 Security Access seed/key exchange",
      "Attempt counter + delay timer anti-brute-force",
      "Service ACL gated by vehicle state (speed = 0, gear = P)",
      "Diagnostic Event Manager (DEM) diagnostic trouble code (DTC) logging + signed audit trail"
    ]
  },
  steps: [
    mkStep(
      ...
      "Diagnostic tester (Diagnostics over Internet Protocol / DoIP / Unified Diagnostic Services / UDS) -> Unified Diagnostic Services (UDS) session manager: diagnosticSessionControl(0x10)",
      ["all", "functional"],
    ...
    mkStep(
      ...
      "Tester requests a seed via Unified Diagnostic Services (UDS) service 0x27.",
      "Unified Diagnostic Services (UDS) session manager -> Texas Instruments Security Accelerator (SA2UL) crypto block: requestSeed(0x27, subfunc=01)",
      ["all", "security"],
      "The security accelerator's true random number generator (TRNG) generates the seed; the electronic control unit (ECU) arms the attempt counter and International Organization for Standardization (ISO) 14229 delay timer before returning it.",
      [
        "seed = SA2UL.trng()",
        "AttemptCounter.arm()",
    ...
    mkStep(
      ...
      "Security Access Handler (0x27) -> Texas Instruments Security Accelerator (SA2UL) crypto block: verifyKey(subfunc=02)",
      ["all", "security"],
      "The security accelerator validates the key computed via the original equipment manufacturer (OEM) Advanced Encryption Standard Cipher-based Message Authentication Code (AES-CMAC) algorithm against the shared secret; failures increment the attempt counter and can trigger the International Organization for Standardization (ISO) 14229 exponential delay timer.",
      [
    ...
    mkStep(
      ...
      "Security Access Handler (0x27) -> Vehicle state / Diagnostic Event Manager (DEM): authorizeService()",
      ["all", "security"],
    ...
    mkStep(
      ...
      "Unified Diagnostic Services (UDS) session manager -> Security Access Handler (0x27): validateDiagPayload()",
      ["all", "functional"],
    ...
    mkStep(
      ...
      "Security Access Handler (0x27) -> Vehicle state / Diagnostic Event Manager (DEM): executeProtectedRoutine()",
      ["all", "functional"],
    ...
    mkStep(
      ...
      "Security Access Handler (0x27) -> Unified Diagnostic Services (UDS) session manager: redactAndRespond()",
      ["all", "security"],
...
export const narrative = {
  overviewIntro:
    "SecureDiagnostics governs authenticated access to Unified Diagnostic Services (UDS) and Diagnostics over Internet Protocol (DoIP) diagnostic services on the Texas Instruments TDA4VM domain controller. It enforces International Organization for Standardization (ISO) 14229 Security Access service 0x27 with Advanced Encryption Standard Cipher-based Message Authentication Code (AES-CMAC) seed/key exchange, attempt-limited brute-force defenses, and Automotive Open System Architecture (AUTOSAR) Diagnostic Event Manager (DEM) vehicle-state gating before any protected diagnostic routine executes.",
  chips: [
    "Unified Diagnostic Services (UDS) 0x27 seed/key security access",
    "Advanced Encryption Standard Cipher-based Message Authentication Code (AES-CMAC) challenge validation",
  ...
  contextCards: [
    {
      ...
      body: "A Diagnostics over Internet Protocol (DoIP) and Unified Diagnostic Services (UDS) tester, such as a workshop tool or backend, opens a diagnostic session and requests Security Access before any write, routine, or protected read is permitted."
    },
    {
      title: "Runtime Enforcement",
      body: "The Security Access Handler validates the seed/key exchange and consults the Automotive Open System Architecture (AUTOSAR) Diagnostic Event Manager (DEM) vehicle state before allowing operations that could affect safety-relevant behavior."
    },
    {
  ...
  controlCards: [
    {
      ...
      body: "The security accelerator computes an Advanced Encryption Standard Cipher-based Message Authentication Code (AES-CMAC) response over the issued seed; only a correctly keyed tester can produce a matching key value."
    },
    {
    ...
    },
    {
      ...
      body: "Automotive Open System Architecture (AUTOSAR) Diagnostic Event Manager (DEM) state, such as vehicle speed and ignition state, is checked before permitting diagnostics that could be unsafe while driving."
    },
    {
  ...
  summaryBullets: [
    "SecureDiagnostics must gate protected services behind seed/key Security Access (0x27).",
  ...
  summaryAssumptions:
    "Reference assumptions used in this simulator: Unified Diagnostic Services (UDS) Security Access level 0x27/0x28 with Advanced Encryption Standard Cipher-based Message Authentication Code (AES-CMAC) seed/key exchange, exponential delay timer starting at 10 seconds after 3 failed attempts, Diagnostic Event Manager (DEM)-gated routines mapped to diagnostic trouble code (DTC) ranges reserved for diagnostic security events, and session timeout of 5 seconds S3 per International Organization for Standardization (ISO) 14229 defaults."
};
